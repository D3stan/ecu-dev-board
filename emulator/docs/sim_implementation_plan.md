...
#### [NEW] [sim_state.h](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/main/sim_state.h) (Core Global Memory Model)
...
typedef struct {
    sim_parameter_t tps;  // 0.0 - 100.0 %
    sim_parameter_t egt;  // 20.0 - 1000.0 °C
    sim_parameter_t rpm;  // 0.0 - 18000.0 RPM
    bool fault_egt_overheat;
    float current_rpm;
    float current_tps;
    float current_egt;
    bool spark_detected;
...
#### [NEW] [main.c](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/main/main.c) (Loop Control & Kinematics)
...
- **Physical Potentiometers (Manual Cockpit)**:
  ...
  - Map the smoothed raw ADC values (0-4095) to physical percentages: 0.0–100.0% for TPS and 20.0–1000.0°C for EGT.
...
#### [NEW] [index_html.h](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/main/index_html.h) (Inlined Web UI Assets)
- Store the compiled and bundled single-file Vite HTML page as a static C character array (`const char index_html[]`).

#### [NEW] [web_builder.py](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/web_builder.py) (Asset Bundling Script)
- Create a Python script in the build chain to compile the Vite project in `emulator/webui`, bundle the built assets into a single static file, and export it directly as `index_html.h`.

#### [NEW] [sim_net.c](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/main/sim_net.c) (esp_http_server Routing)
...
#### [NEW] [sim_io_capture.c](file:///Users/puddu/Documents/GitHub/ecu-dev-board/emulator/main/sim_io_capture.c) (Timing Interrupt Service Routine)
...
### Manual Verification
- **Cockpit Potentiometer Tuning**: Verify that turning physical potentiometers updates `g_sim_state.tps.physical_val` and `g_sim_state.egt.physical_val` with smoothed values, and that this changes the target RPM / EGT correctly.
