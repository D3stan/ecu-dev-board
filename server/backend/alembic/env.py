...
Uses asyncpg driver (postgresql+asyncpg) via run_sync to execute migrations.
DATABASE_URL is read from app.config.settings, which reads from the environment.
"""
import asyncio
